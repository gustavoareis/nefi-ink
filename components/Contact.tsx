...
const INSTAGRAM_HANDLE = 'nefi.ink'
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-28 md:py-40 px-6 overflow-hidden">
      ...
      >
        <span
          className="font-display font-black text-[#c41e1e] leading-none"
          style={{ fontSize: 'clamp(8rem, 28vw, 22rem)', opacity: 0.025 }}
        >
          INK
        </span>
      </div>
      ...
      <div ref={ref} className="max-w-3xl mx-auto text-center relative">
        ...
        >
          ...
          <a
            ...
            className="group relative flex items-center justify-center gap-3 px-10 py-4 bg-[#c41e1e] text-[#e8e0d0] font-mono text-[10px] uppercase tracking-[0.3em] overflow-hidden transition-all duration-300 hover:bg-transparent border border-[#c41e1e]"
          >
            <span className="absolute inset-0 bg-[#c41e1e] translate-x-0 group-hover:-translate-x-full transition-transform duration-400 ease-in-out" />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 px-10 py-4 border border-[#e8e0d0]/20 text-[#e8e0d0]/60 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-[#c41e1e] hover:text-[#c41e1e] transition-all duration-300"
          >
            <InstagramIcon />
            @{INSTAGRAM_HANDLE}
          </a>
